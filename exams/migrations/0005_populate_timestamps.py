...
def populate_created_updated(apps, schema_editor):
    ...
    for exam_profile in ExamProfile.objects.filter(
        ...
        exam_profile.created_on = datetime(
            2017, 3, 1, tzinfo=pytz.UTC
        )  # ExamProfile records created for the beta
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            populate_created_updated, reverse_code=migrations.RunPython.noop
        ),
    ]
