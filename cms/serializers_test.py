    ...
    def test_program_page_serializer(self):
        ...
        assert data == {
            ...
            "faculty": FacultySerializer(
                sorted(faculty, key=lambda member: member.name), many=True
            ).data,
