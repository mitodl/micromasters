...
from grades.api import generate_program_certificate_after_course_cert_created
...
def handle_create_coursecertificate(sender, instance, created, **kwargs):  # pylint: disable=unused-argument
    ...
    """
    if created:
        transaction.on_commit(lambda: generate_program_certificate_after_course_cert_created(instance))
