...
class FinalGradeAdmin(admin.ModelAdmin):
    ...
    @admin.display(
        description="Edx Course Key",
        ordering="course_run__edx_course_key",
    )
...
admin.site.register(
    models.MicromastersCourseCertificate, MicromastersCourseCertificateAdmin
)
admin.site.register(
    models.MicromastersProgramCertificate, MicromastersProgramCertificateAdmin
)
admin.site.register(
    models.MicromastersProgramCommendation, MicromastersProgramCommendationAdmin
)
