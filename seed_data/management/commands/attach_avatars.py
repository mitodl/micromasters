...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            " to all fake users generated by seed_db.".format(
    ...
    def handle(self, *args, **options):
        profile_queryset = Profile.objects.filter(
            user__username__startswith=options["username_prefix"]
        )
        self.stdout.write(
            f"Attaching robot avatars to {profile_queryset.count()} profiles..."
        )
