...
OPEN_DISCUSSIONS_JWT_EXPIRES_DELTA = get_int(
    "OPEN_DISCUSSIONS_JWT_EXPIRES_DELTA", 60 * 60
)
...
OPEN_DISCUSSIONS_REDIRECT_COMPLETE_URL = get_string(
    "OPEN_DISCUSSIONS_REDIRECT_COMPLETE_URL", "/"
)
