...
class ProfileTests(MockedESTestCase):
    ...
    def test_add_education(self):
        ...
        serializer = ProfileSerializer(
            ...
            data={"education": [education_object], "work_history": []},
        )
    ...
    def test_update_education(self):
        ...
        serializer = ProfileSerializer(
            instance=education.profile,
            data={"education": [education_data], "work_history": []},
        )
        serializer.is_valid(raise_exception=True)
        serializer.save()
    ...
    def test_delete_education(self):
        ...
        serializer = ProfileSerializer(
            instance=education1.profile,
            data={"education": [education_object1], "work_history": []},
        )
        serializer.is_valid(raise_exception=True)
        serializer.save()
    ...
    def test_add_employment(self):
        ...
        serializer = ProfileSerializer(
            instance=user1.profile,
            data={"work_history": [employment_object], "education": []},
        )
        serializer.is_valid(raise_exception=True)
        serializer.save()
    ...
    def test_delete_employment(self):
        ...
        serializer = ProfileSerializer(
            instance=employment1.profile,
            data={"work_history": [employment_object1], "education": []},
        )
        serializer.is_valid(raise_exception=True)
        serializer.save()
...
class ProfileFilledOutTests(ProfileImageCleanupMixin, MockedESTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.profile.user.social_auth.create(
            provider=EdxOrgOAuth2.name, uid=f"{cls.profile.user.username}_edx"
        )
    ...
    def test_required_fields(self):
        ...
        self.assert_required_fields(
            keys, lambda profile: profile, lambda profile: profile
        )
