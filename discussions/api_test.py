...
def test_create_discussion_user_error(mock_staff_client):
    ...
    assert str(exc.value) == f"Error creating discussion user for {profile.user.username}"
...
def test_update_discussion_user_error(mock_staff_client):
    ...
    assert str(exc.value) == f"Error updating discussion user for {profile.user.username}"
